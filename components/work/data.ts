...
export const Projects: ProjectT[] = [
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1675561334/Screenshot_3_ykbr0a.jpg",
    imagesUrl: [
      {
        id: "1",
        title: "",
  ...
  },
  {
    ...
    description:
      "Página estática hecha usando NextJS en su versión 13, para una profesional en enfermería.",
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1675559062/PORTFOLIO/Screenshot_6_acp7l7.jpg",
    imagesUrl: [
      {
        id: "1",
        title: "",
...

  {
    ...
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1671401089/addintech/Screenshot_2_szg8ud.jpg",
    imagesUrl: [
      {
        id: "1",
...

  {
    ...
    description:
      "Diseño y desarrollo de una SPA basada en la serie Rick and Morty.",
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1665871790/book/Screenshot_5_mnhm47.jpg",
    imagesUrl: [
      {
        id: "1",
        title: "",
  ...
  },
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1664077398/cld-sample-5.jpg",
    imagesUrl: [
      {
        id: "1",
  ...
  },
  {
    ...
    description:
      "Diseño y desarrollo de una simple app que consume una api, nos permite ver el clima",
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1664233159/PORTFOLIO/Screenshot_2_jxfaeu.jpg",
    imagesUrl: [
      {
        id: "1",
  ...
  },
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1665245797/book/Screenshot_1_sd8pmx.jpg",
    imagesUrl: [
      {
        id: "1",
    ...
    contribution:
      "Crear un backend, usando un motor de plantillas como EJS para la interfaz.",
  },
  {
    id: "5",
    title: "Todo App",
    subtitle:
      "Una app donde podemos agregar Tareas a realizar, tacharlas y borrarlas",
    description: "Diseño y desarrollo de una simple app para gestión de tareas",
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1665247621/todoapp/Screenshot_1_aa9ze0.jpg",
    imagesUrl: [
      {
        id: "1",
    ...
    role: "Diseño y desarrollo",
    contribution:
      "En este proyecto aprendí el uso de React-Context y React-Portal, sus distintos usos y utilidades.",
  },
  {
    id: "6",
    title: "Portfolio",
    ...
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1665189624/Photo/Screenshot_1_o8pm5w.jpg",
    imagesUrl: [
      {
        id: "1",
        title: "",
    ...
    contribution:
      "En este pequeño proyecto aprendi conceptos como responsive design y el uso de CSS Grid",
  },
  {
    id: "7",
    title: "Bata-bit",
    ...
    description:
      "Tomando un diseño de una pagina en la web, hice la maquetación usando html y css",
    imageUrl:
      "https://res.cloudinary.com/dg84upfsp/image/upload/v1665190068/Photo/Screenshot_5_hsg5ek.jpg",
    imagesUrl: [
      {
        id: "1",
        title: "",
